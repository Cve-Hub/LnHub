...
local Star = nill:Window("LUNAR HUB [FREE VERSION]")
local StarServer = Star:Server("LUNAR HUB",8521503225)



local Main = StarServer:Channel("Main") -- Main
...
local Settings = StarServer:Channel("Settings")  -- setting
...
Settings:Toggle("Toggle ", _G.Toggle, function(vu)
_G.Toggle = vu
end)

local Stats = StarServer:Channel("Stats") -- Stats

Stats:Toggle("Toggle ", _G.Toggle, function(vu)
_G.Toggle = vu
end)

local Fruit = StarServer:Channel("Fruits & Esp")

Fruit:Toggle("Toggle ", _G.Toggle, function(vu)
_G.Toggle = vu
end)

local Raid = StarServer:Channel("Raids")

Raid:Toggle("Toggle ", _G.Toggle, function(vu)
_G.Toggle = vu
end)

local Misc = StarServer:Channel("Misc")

Misc:Toggle("Toggle ", _G.Toggle, function(vu)
_G.Toggle = vu
end)

local About = StarServer:Channel("About")

local Hub = StarServer:Channel("Hubs")
