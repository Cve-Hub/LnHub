...
local Main = library:Window("Some X Hub Edit Ren Hub","Blox Friit (17.01 Beta)")
...
StatsTab:Toggle("Melee",getgenv().Setting["Melee"],function(value)
    melee = value    
end)
StatsTab:Toggle("Defense",getgenv().Setting["Defense"],function(value)
    defense = value
end)
StatsTab:Toggle("Sword",getgenv().Setting["Sword"],function(value)
    sword = value
end)
StatsTab:Toggle("Gun",getgenv().Setting["Gun"],function(value)
    gun = value
end)
StatsTab:Toggle("Demon Fruit",getgenv().Setting["Demon Fruit"],function(value)
    demonfruit = value
end)
PointStats = 1
