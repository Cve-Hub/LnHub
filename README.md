...
Main:Toggle("Auto ", _G.H, function(vu)
end)
...
Sec = 50
Main:Slider("Time", 1,250,Sec, function(Value)
	Sec = Value
end)


AutoFarm:Slider("b",function(Value)
    
end)

local Settings = StarServer:Channel("Settings")

Settings:Toggle("BringMob", true, function()
    
end)

local Stats = StarServer:Channel("Stats")

Stats:Toggle("Melee", _G., function()
    
end)

local Players = StarServer:Channel("Players")

Players:Toggle("lol", _G., function()
    
    end)

local Raid = StarServer:Channel("Raid & Esp")

local Fruits = StarServer:Channel("Fruits")
